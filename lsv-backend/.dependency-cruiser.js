  ...
  forbidden: [
    {
      ...
      comment: "Application layer should depend on domain, not on concrete implementations of infrastructure",
      severity: "error",
      from: { path: "application" },
      to: { path: "infrastructure", pathNot: "domain" }
    },
    {
      name: "not-cross-dependency-slices",
      comment: "Slices should not depend on each other",
      severity: "error",
      from: { path: "^slices/[^/]+/.*" },
      to: { path: "^slices/[^/]+/.*" }
    },
    {
      ...
      comment: "Domain layer should be independent and should not depend on application or infrastructure",
      severity: "error",
      from: { path: "domain" },
...
// generated: dependency-cruiser@16.10.0 on 2025-02-27T04:29:47.109Z
